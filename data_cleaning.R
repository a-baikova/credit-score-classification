...
dados <- fread('CreditDataset.csv')

dados_clean <- data.frame(dados) #converte para dataframe

#####Limpeza das variáveis#####
# Remove underscores e aspas de todas as colunas exceto Customer_ID e Payment_Behaviour
...
# Imputação de valores menores que 14 e mairoes que 56
...
# Clientes com ocupação registada
...
# preencher NAs dentro do Customer_ID
...
# Variaveis dummy para tipo de emprestimo
