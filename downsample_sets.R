...
set.seed(100)
index_1 <- sample(1:nrow(dados_clean), round(nrow(dados_clean) * 0.75))
...
treino_1 <- downSample(treino_1[,-16],treino_1$Credit_Score) 

colnames(treino_1)[colnames(treino_1) == "Class"] <- "Credit_Score"
